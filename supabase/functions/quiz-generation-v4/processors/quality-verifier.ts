...
import { QuestionPlan, BaseQuestion, QuestionGenerationError } from '../types/interfaces.ts';
...
const buildQualityVerificationPrompt = (question: BaseQuestion, plan: QuestionPlan): string => {
...
**Timestamp**: ${question.timestamp} seconds
...
const formatAnswerDetails = (question: BaseQuestion): string => {
...
export const qualityVerifierConfig = {
  processorName: 'Gemini Quality Verifier v4.0',
  stage: 3,
